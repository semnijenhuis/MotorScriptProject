...
public class Compiler {
    ...
    private final ParseTreeProperty<SymbolTable> scope = new ParseTreeProperty<>();
    ...
    private ParseTree runLexerAndParser(CharStream input) {
        MotorScriptLangLexer lexer = new MotorScriptLangLexer(input);
        lexer.addErrorListener(getErrorListener());
        CommonTokenStream tokens = new CommonTokenStream(lexer);

        MotorScriptLangParser parser = new MotorScriptLangParser(tokens);
    ...
    private boolean runChecker(ParseTree parseTree) {
        ...
        Checker checker = new Checker(types, scope);
    ...
    private JasminBytecode generateCode(ParseTree parseTree, String className) {
        ...
        CodeGenerator codeGenerator = new CodeGenerator(types, jasminBytecode, scope, className);
        FunctionGenerator functionGenerator = new FunctionGenerator(types, jasminBytecode, scope, codeGenerator);
        ...
        jasminBytecode.add("");
        functionGenerator.visit(parseTree);
     ...
     * Main method.
     *
     * @param args arrays.md of command line arguments. You can use this to supply the file name to
     *             compile.
     */
